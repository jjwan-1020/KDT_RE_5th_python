...
console.log('???', a) // 선언되지 않은 변수 출력 시 에러 발생 x, 그냥 undefined 출력

// 변수 선언
var a;
console.log('변수 선언', a); // undefined 출력 (아직 a라는 변수에 값이 할당 되지 않았기 때문)
...
// const 선언
// const c; // const를 사용한 변수 선언 시 초기화 무조건 동시에 진행해야 한다
const c = 5000000;
