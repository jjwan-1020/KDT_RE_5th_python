...
- 통신 속도는 대체로 9600을 사용
  - 오래 전부터 사용해온 안정적이고 에러 없는 표준 속도
    - 통신 속도가 너무 빠르면 데이터 손실이 생김, 느리면 데이터 전송이 불편함
  - 거의 모든 장치가 지원하는 속도
- setup()함수 내에 한 번만 작정하면 됨

Serial.print()
- 아두이노에서 pc(시리얼 모니터)로 문자나 숫자, 변수 값을 보내주는 함수
